...
export const BOARD_EMAIL_CONFIG = {
  ...
  "5052958230": {
    emailColumnId:  "email_mkxmc5yw",
    statusColumnId: "color_mm029qq0",
    triggers: {
      "Email 4 sendt": "email4",
    },
  },
};
...
Håreksperten`,
  ...
  email4: {
    subject: "Plan og program for dit ophold & Hårplan",
    attachments: [
      { url: `${BLOB}/4.%20Alt%20du%20skal%20vide%20efter%20din%20h%C3%A5rtransplantation.pdf`, filename: "4. Alt du skal vide efter din hårtransplantation.pdf" },
      { url: `${BLOB}/5.%20Plan%20og%20program.pdf`,                                            filename: "5. Plan og program.pdf" },
    ],
    body: (name) => `Kære ${name}

Nu nærmer din rejse med Håreksperten sig.

Her finder du plan og program for dit ophold i Istanbul. Du finder også din hårplan, som fungerer som din vejledning efter operationen. Du modtager den på forhånd, så du kan forberede eventuelle spørgsmål.

Du kan se vores præsentationsvideoer af hotellet og klinikken (link i PDF'en).

Vi har planlagt hele din rejse, så du kan nyde dit ophold.
