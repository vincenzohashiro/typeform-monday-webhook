...
// Monday converts stored UTC to the workspace timezone for display.
// Workspace must be set to Europe/Copenhagen so Danish staff see the correct time.
// e.g. 12:34 TR (UTC+3) → 09:34 UTC stored → Monday shows 11:34 Copenhagen (UTC+2 CEST) ✓
